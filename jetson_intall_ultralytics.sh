...
# Confirm user is running Jetpack 6.2 (L4T 36.5)
...
if [[ "$L4T_RELEASE" == "36" && "$L4T_REVISION" == "5"* ]]; then
    echo "JetPack version is correct (6.2.2 / L4T $L4T_RELEASE.$L4T_REVISION)"
else
    echo "Wrong version of NVIDIA JetPack is installed."
    echo "Detected L4T: R$L4T_RELEASE Revision $L4T_REVISION"
    echo "Please install JetPack 6.2.2 from the SD Card Image downloadable at: https://developer.nvidia.com/embedded/jetpack-sdk-622"
...
# Install special versions of torch and torchvision (compatible with Jetpack 6.2.2)
